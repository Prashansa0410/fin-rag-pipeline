...
class ModelRegistry:
    ...
    def __init__(self):
        self.models = {
            ...
            "advanced": {"model_id": settings.ADVANCED_MODEL, "provider": "huggingface", "tier": "advanced", "display_name": "Advanced", "capability_score": 0.98, "latency_class": "high", "context_limit": 32768, "input_cost": 0.01, "output_cost": 0.02, "response_token_reserve": 3000, "token_safety_margin": 1000, "health_status": "unknown"},
